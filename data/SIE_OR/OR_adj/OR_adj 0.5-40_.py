...
for i in range(48):
    ...
    for subject in range(1,10):
        path_plv = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/OR_Weight/SIE_plv/" + str(top_indices) + "SIE_plv_0.5-40_576_value_" + str(subject) + ".mat"
        plv_arr = scio.loadmat(path_plv)["data"]
        path_msc = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/OR_Weight/SIE_msc/" + str(top_indices) + "SIE_msc_0.5-40_576_value_" + str(subject) + ".mat"
        msc_arr = scio.loadmat(path_msc)["data"]
        path_pearson = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/OR_Weight/SIE_pcc/" + str(top_indices) + "SIE_pcc_0.5-40_576_value_" + str(subject) + ".mat"
        ...
        for i in range(22):
            for j in range(22):
                if((plv_result_array[i][j]==1 or msc_result_array[i][j]==1 or pearson_result_array[i][j]==1) and i != j):
        ...
        filename = str(top_indices) + "SIE_0.5-40_576_OR_top_indices" + str(top_indices) + "_adj_" + str(subject) + ".mat"
