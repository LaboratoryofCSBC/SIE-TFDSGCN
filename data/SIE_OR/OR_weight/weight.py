...
for i in range(48):
    ...
    for subject in range(1,10):
        ...
        path_adj = "/home/tang/work/WTZ/BCI/Data/2a/adj and weight/adj_AND/0.5-40_576_AND_top_indices" + str(num_nodes) + "_adj_" + str(subject) + ".mat"
        ...
        # filename = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/Weight/SIE_plv/" + str(num_nodes) + "SIE_plv_0.5-40_576_value_" + str(subject) + ".mat"
        # scio.savemat(filename,  {'data': plv_matrix})
        # filename = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/Weight/SIE_msc/" + str(num_nodes) + "SIE_msc_0.5-40_576_value_" + str(subject) + ".mat"
        # scio.savemat(filename,  {'data': msc_matrix})
        # filename = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/Weight/SIE_pcc/" + str(num_nodes) + "SIE_pcc_0.5-40_576_value_" + str(subject) + ".mat"
        # scio.savemat(filename,  {'data': pcc_matrix})
        # filename = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/Weight/SIE_plv_msc_pcc/" + str(num_nodes) + "SIE_plv_msc_pcc_0.5-40_576_value_" + str(subject) + ".mat"
        # scio.savemat(filename,  {'data': plv_msc_pcc_matrix})
