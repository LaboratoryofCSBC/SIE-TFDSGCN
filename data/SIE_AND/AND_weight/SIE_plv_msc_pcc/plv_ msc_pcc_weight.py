...
for i in range(48):
    ...
    for subject in range(1,10):
        ...
        path_plv = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/Weight/SIE_plv/" + str(num_nodes) + "SIE_plv_0.5-40_576_value_" + str(subject) + ".mat"
        plv_arr = scio.loadmat(path_plv)["data"]
        # path_msc = "/home/tang/work/WTZ/BCI/GCN-eeg/MSC/0.5-40_576_value_"+ str(subject) +".mat"
        path_msc = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/Weight/SIE_msc/" + str(num_nodes) + "SIE_msc_0.5-40_576_value_" + str(subject) + ".mat"
        msc_arr = scio.loadmat(path_msc)["data"]
        # path_pearson = "/home/tang/work/WTZ/BCI/GCN-eeg/pearson/0.5-40_576_value_" + str(subject) + ".mat"
        path_pearson = "/home/tang/work/WTZ/BCI/GCN-eeg/source_Graph/Weight/SIE_pcc/" + str(num_nodes) + "SIE_pcc_0.5-40_576_value_" + str(subject) + ".mat"
